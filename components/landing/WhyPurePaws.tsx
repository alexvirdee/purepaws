    ...
    return (
        <div className="mt-8 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-600 text-base mb-6 max-w-2xl mx-auto">
                At PurePaws, we're committed to creating a safe, transparent, and ethical space for both responsible breeders and loving pet parents. Every breeder is reviewed with care to ensure they are following best practices so you can focus on finding your perfect pup with confidence.
            </p>
